...
void function CreateGamemode() {
	...
	GameMode_AddScoreboardColumnData( GAMEMODE_BR, "#SCOREBOARD_BR_PLANTED_BOMBS", PGS_TITAN_KILLS, 2 )
    GameMode_AddScoreboardColumnData( GAMEMODE_BR, "#SCOREBOARD_BR_DEFUSED_BOMBS", PGS_DEFENSE_SCORE, 2)
...
void function BRRegisterNetworkVars()
{
    ...
    Remote_RegisterFunction( "ServerCallback_AnnounceBombWasDropped" )
    ...
    Remote_RegisterFunction( "ServerCallback_BombingRunInitBombIcon" )
